def load_into_branch_table(connection, branch_info):
    try:
        ...
        print(f"load_into_branch_table: error occurred - {e}")
...
def load_into_product_table(connection, product_info):
    try:
        ...
        print(f"load_into_product_table: error occurred - {e}")
...
def load_into_transaction_table(connection, transaction_info):
    try:
        ...
        print(f"load_into_transaction_table: error occurred - {e}")
...
def load_into_orders_table(connection, orders_info):
    try:
        ...
        print(f"load_into_orders_table: error occurred - {e}")